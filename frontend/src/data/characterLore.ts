...
export const CHARACTERS: Record<BotId, CharacterLore> = {
  wick: {
    ...
    targetItem: {
      ...
      description: "A heavy, dual-chambered brass medallion sealed with a dried thumbprint in blood. Represents an unbreakable, life-and-death debt under High Table law.",
  ...
  spidey: {
    ...
    targetItem: {
      ...
      description: "A precision-lathed aluminum cylinder filled with Parker's proprietary shear-thinning polymer. Pressurized to 300 psi with a brass needle-valve.",
  ...
  escanor: {
    ...
    targetItem: {
      ...
      description: "A jagged fragment sheared from Rhitta’s crescent blade. Radiates unbearable heat that warps ambient light and stores pure solar kinetic energy.",
  ...
  stark: {
    ...
    targetItem: {
      ...
      description: "The miniaturized clean-energy chest piece that preserved Stark's life and powered the Mark II flight systems. Emits a steady 3 gigajoules per second.",
  ...
  joker: {
    ...
    targetItem: {
      ...
      description: "A vintage playing card drenched in chemical solvent and scrawled with an alphanumeric transposition cipher. Unlocks the Arkham broadcast network.",
  ...
  light: {
    ...
    targetItem: {
      ...
      description: "A ragged black parchment sliver torn from the Shinigami notebook. A criminal's name is crossed out in dry red ink, sealing their fate.",
  ...
  levi: {
    ...
    targetItem: {
      ...
      description: "A parchment dispatch detailing the secret expedition outside the Walls, secured by the emerald wax seal of the Wings of Freedom.",
  ...
  deadpool: {
    ...
    targetItem: {
      ...
      description: "Two forged carbon-steel cross pins that anchor the dual katanas named Bea and Arthur to Deadpool's tactical back sheath.",
  ...
  itachi: {
    ...
    targetItem: {
      ...
      description: "A mystical raven harboring the legendary left Mangekyo eye of Shisui Uchiha, programmed with Kotoamatsukami to cast the ultimate defense over the Leaf.",
  ...
  aizen: {
    ...
    targetItem: {
      ...
      description: "The miracle sphere forged by Kisuke Urahara and perfected by Aizen. Pulses with cosmic blue-violet reiatsu, bridging the boundary between Soul Reaper and Hollow.",
